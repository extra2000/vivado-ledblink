...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../src/verilog/ledblink.v"]"\
 "[file normalize "$origin_dir/../src/constrs/artyz7-20.xdc"]"\
 "[file normalize "$origin_dir/../sim/ledblink_tb.v"]"\
 "[file normalize "$origin_dir/../sim/ledblink_tb_behav.wcfg"]"\
  ]
  foreach ifile $files {
...
set orig_proj_dir "[file normalize "$origin_dir/../run/ledblink"]"
...
set obj [get_filesets sim_1]
set_property -name "top" -value "ledblink_tb" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
...
if { [get_files ledblink.v] == "" } {
  import_files -quiet -fileset sources_1 "${origin_dir}/../src/verilog/ledblink.v"
}
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#reset#gpio[10]#gpio[11]#gpio[12]#gpio[13]#rx#tx#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#gpio[48]#gpio[49]#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  connect_bd_net -net Net [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0]
  connect_bd_net -net ledblink_0_led_o [get_bd_ports led_o_0] [get_bd_pins ledblink_0/led_o]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins ledblink_0/clk_i] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
...
if { [get_property IS_LOCKED [ get_files -norecurse arty_z7_20.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../run/ledblink/ledblink.gen/sources_1/bd/arty_z7_20/hdl/arty_z7_20_wrapper.v" ]
} else {
